# Title:  Rescue Rangers Test Code - Face Detection using Thermal Camera Lepton 3.5 module on OpenMV camera board
...
#
# The following code runs on OpenMV H7 camera board after powering up
# with FLIR Lepton 3.5 Thermal sensor installed
# OpenMV board is powered and connected to the ZumoShield for Arduino board
# Communication between OpenMV and Arduino is over TX/RX
# OpenMV micropython code will message Arduino board when face is detected from thermal camera HFOV (60 degrees)
